...
const CuisineSearch: FC<CuisineSearchProps> = ({ setCuisine }) => {
  ...
  function handleInputChange(event: React.ChangeEvent<HTMLInputElement>) {
    setCuisineStore(event.target.value);
  }
  ...
  return (
    <div className="">
      ...
      />
      {isDropdownOpen && (
        <div className="absolute z-10 mt-2 max-h-28 w-1/5 overflow-y-auto rounded-md border-2 border-gray-300 bg-white p-2">
          <ul className="py-1">
