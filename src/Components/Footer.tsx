...
const Footer: FC = () => {
  return (
    <footer className="text-center text-white bg-green-500">
      <div className="container pt-9 max-w-full">
        <div className="flex justify-center mb-9 origin-center w-auto">
      ...
      <div className="text-center text-gray-700 p-4 bg-green-700">
        © 2021 Copyright:
